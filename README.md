...
- U-Boot 1.1.4 (http://git.denx.de/?p=u-boot.git;a=summary)
- pepe2k U-Boot mod (https://github.com/pepe2k/u-boot_mod)
- 8devices caraboot (https://github.com/8devices/Caraboot)

To prepare USB flash drive:
- Format USB drive into FAT or FAT32 filesystem
- Place one of the following files on it:
